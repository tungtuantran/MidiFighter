...
Nach der Anforderungsanalyse wurden folgende Hauptanforderungen für die Anwendung festgelegt:

1. Da dies eine Anwendung ist, mit der man Musik produzieren kann, müssen alle Interaktionen schnell sein, um zum Beispiel im richtigen Rhythmus zu bleiben.

2. Es sollte ein visuelles Keyboard erstellt werden, das sowohl durch Maus-Klicks als auch durch die Tastatur gesteuert werden kann. Die Steuerung durch die Tastatur ist wichtig, da man damit schnellere Eingaben machen kann, was für eine Drum Machine sehr wichtig ist.
...
4. Die erzeugte Musik muss visualisiert werden, und zwar sowohl die Hintergrundmusik als auch die mit dem Keyboard erzeugten Töne.
...
Bei der Verwendung der Web-Audio-API ist zu beachten, dass die Nodes, die für die Audio-Wiedergabe zuständig sind, mit dem Destination-Node verbunden werden. Erst dadurch kann man die wiedergegebene Audio hören. In der entwickelten Anwendung wurden jedoch zwischen Destination und dem Input mehrere Nodes zwischengeschaltet. Diese wären: 
