...
class Metronome extends PureComponent {
    ...
    render(){
        ...
        return (<React.Fragment>
            ...
            <h4 style={this.styles.hStyle}>Metronome</h4>
            <button className=" btn btn-light  ml-1 mb-2"   onClick={() => this.props.onToolDelete("Metronome")}>
            <Octicon icon={Dash}/>
            </button>
            ...
            <center>
            <div style={this.styles.boxStyle}>
            <ClockHand bpm={this.state.bpm} clockHandStyle={this.styles.clockHandStyle} />
            </div>
            </center>
            </div>
...
function ClockHand(args) {
    ...
    return <animated.div style={props}><div style={args.clockHandStyle}></div></animated.div>
}
